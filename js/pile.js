export function initPileModule(container) {
    ...
    function calculateHorizontalSoilReaction(alphaNorm, Ep, D, Ip_cm4, layers) {
        ...
        // 3. 후쿠오카 공식 축차계산 (상시/지진시 구분 없음 - 1회 단일계산)
        let betaF = 0.20000;
        let stepsFukuoka = [];
    ...
    function calculatePileCapacity() {
        ...
        // 5. 연직 침하량 검토 (기성말뚝/토사층: Vesic 경험식, 기반암: Pells & Turner)
        ...
        if (p_type === 'CAST_ROCK') {
            ...
            // 기성말뚝 (PHC, 강관) 및 토사층 말뚝: Vesic (1977) 경험적 침하 산정식 (Cp, Cs 적용)
            ...
            let calc_qp = Math.max(q_p, 1.0); // 0으로 나누기 방지
